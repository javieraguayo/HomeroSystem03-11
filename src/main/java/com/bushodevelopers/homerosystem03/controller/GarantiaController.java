...
import com.bushodevelopers.homerosystem03.model.Garantia;
...
import com.bushodevelopers.homerosystem03.ejb.GarantiaFacade;
...
@Named("garantiaController")
@SessionScoped
public class GarantiaController implements Serializable {

    @EJB
    private com.bushodevelopers.homerosystem03.ejb.GarantiaFacade ejbFacade;
    private List<Garantia> items = null;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("GarantiaCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("GarantiaUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("GarantiaDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public List<Garantia> getItemsAvailableSelectMany() {
        return getFacade().findAll();
    }

    public List<Garantia> getItemsAvailableSelectOne() {
        return getFacade().findAll();
    }
    ...
    public static class GarantiaControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getGarantia(getKey(value));
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Garantia) {
                ...
                return getStringKey(o.getId_garantia());
            } else {
