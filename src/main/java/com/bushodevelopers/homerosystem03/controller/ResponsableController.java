...
import com.bushodevelopers.homerosystem03.model.Responsable;
...
import com.bushodevelopers.homerosystem03.ejb.ResponsableFacade;
...
public class ResponsableController implements Serializable {
    ...
    @EJB
    private com.bushodevelopers.homerosystem03.ejb.ResponsableFacade ejbFacade;
    ...
    public static class ResponsableControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Responsable) {
                ...
                return getStringKey(o.getId_responsable());
            } else {
