...
import com.bushodevelopers.homerosystem03.model.Rol;
...
import com.bushodevelopers.homerosystem03.ejb.RolFacade;
...
public class RolController implements Serializable {
    ...
    @EJB
    private com.bushodevelopers.homerosystem03.ejb.RolFacade ejbFacade;
    ...
    public static class RolControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Rol) {
                Rol o = (Rol) object;
                return getStringKey(o.getId_rol());
            } else {
