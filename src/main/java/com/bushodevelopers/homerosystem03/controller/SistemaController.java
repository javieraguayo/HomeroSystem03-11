...
import com.bushodevelopers.homerosystem03.ejb.SistemaFacade;
...
public class SistemaController implements Serializable {
    ...
    @EJB
    private com.bushodevelopers.homerosystem03.ejb.SistemaFacade ejbFacade;
    private List<Sistema> items = null;
    private Sistema selected;
    ...
    public Sistema prepareCreate() {
        selected = new Sistema();
        initializeEmbeddableKey();
        return selected;
    }

    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("SistemaCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("SistemaUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("SistemaDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public List<Sistema> getItemsAvailableSelectMany() {
        return getFacade().findAll();
    }

    public List<Sistema> getItemsAvailableSelectOne() {
        return getFacade().findAll();
    }
    ...
    public static class SistemaControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Sistema) {
                ...
                return getStringKey(o.getId_sistema());
            } else {
                Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), Sistema.class.getName()});
                return null;
            }
        }
