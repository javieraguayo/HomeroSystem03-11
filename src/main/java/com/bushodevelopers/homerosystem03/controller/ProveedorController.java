...
import com.bushodevelopers.homerosystem03.model.Proveedor;
...
import com.bushodevelopers.homerosystem03.ejb.ProveedorFacade;
...
public class ProveedorController implements Serializable {
    ...
    @EJB
    private com.bushodevelopers.homerosystem03.ejb.ProveedorFacade ejbFacade;
    ...
    public static class ProveedorControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Proveedor) {
                ...
                return getStringKey(o.getId_proveedor());
            } else {
